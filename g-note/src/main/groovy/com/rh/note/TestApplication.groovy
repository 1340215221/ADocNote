...
class TestApplication extends JButton {
    public TestApplication(String label){
        super(label);
    ...
    protected void paintComponent(Graphics g){
        ...
        //当矩形为正方形时,画出的椭圆便是圆
        g.fillOval(0,0,(int) getSize().width-1,(int) getSize().height-1);
    ...
    protected void paintBorder(Graphics g){
        ...
        g.drawOval(0,0,(int) getSize().width-1,(int) getSize().height-1);
    }
    ...
    public static void main(String[] args){
        JButton button=new TestApplication("Click me");//产生一个圆形按钮
