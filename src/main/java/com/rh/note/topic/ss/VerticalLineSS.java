...
public class VerticalLineSS extends BaseStreetStall implements IStreetStall {
    ...
    public Square.Cell getCell3() {
        if (cell3 == null) {
            cell3 = new Square.Cell(cell.getX(), cell.getY() + 2);
        }
        return cell3;
    }
    ...
    public Square.Cell getCell4() {
        if (cell4 == null) {
            cell4 = new Square.Cell(cell.getX(), cell.getY() + 3);
        }
        return cell4;
    }
}
