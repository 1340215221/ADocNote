...
//		URL url = getClass().getResource("bookmark.png");
		URL url = URLUtil.getURL(new File("/my_code/ADocNote/temp/bookmark.png"));
...
//errorStrip.setBackground(java.awt.Color.blue);
	...
	private void setText(String resource) {
		BufferedReader r = FileUtil.getReader("/my_code/ADocNote/temp/" + resource, CharsetUtil.UTF_8);
		try {
